...
export const allBlogs = [buildingProgressiveWebAppsBridgingTheGapBetweenWebAndMobile__indexMdx, jsFrameworksComparison__indexMdx, automatingRepetitiveTasksProductivityHacksForDevelopers__indexMdx, bestPracticesForWritingCleanAndMaintainableCode__indexMdx, masteringCssGridLayout__indexMdx, progressiveWebAppsPwa__indexMdx, restfulApisBuildingBlocks__indexMdx, mindfulnessAndMeditationTechniquesForDevelopersImprovingFocusAndClarity__indexMdx, webAccessibilityBestPractices__indexMdx, webAccessibilityInclusiveDesign__indexMdx, webDevelopmentToolsProductivity__indexMdx]
