            ...
            <div className="absolute bottom-0 z-20 w-full p-4 xs:p-6 sm:p-10">
                {blog.tags && blog.tags.length > 0 && (
                    <Tag
                        ...
                        className="!border px-6 py-1 sm:py-2 text-xs sm:text-sm"
                    />
                )}
                <Link href={blog.url} className="mt-6">
                    <h2 className="sm:mt-4 mt-2 text-sm xs:text-base sm:text-xl md:text-2xl font-bold capitalize text-light">
